        ...
        <div class="col">
          ...
          <div class="breadcrumbs d-flex flex-row align-items-center">
            <ul>
              ...
              <li>
                <router-link to="/catagories">men's</router-link>
              </li>
              <li class="active">
                <a href="#"
              ...
              <div class="col-lg-3 thumbnails_col order-lg-1 order-2">
                <div class="single_product_thumbnails">
                  <ul>
                    <li>
                      <img
                        src="image/single_1_thumb.jpg"
                        alt=""
                        data-image="image/single_1.jpg"
                      />
                    </li>
                    <li class="active">
                      <img
                        src="image/single_2_thumb.jpg"
                        alt=""
                        data-image="image/single_2.jpg"
                      />
                    </li>
                    <li>
                      <img
                        src="image/single_3_thumb.jpg"
                        alt=""
                        data-image="image/single_3.jpg"
                      />
                    </li>
                  </ul>
                </div>
              ...
              <div class="col-lg-9 image_col order-lg-2 order-1">
                <div class="single_product_image">
                  <div
                    ...
                    style="background-image: url(image/single_2.jpg)"
                  ></div>
                </div>
              </div>
            </div>
